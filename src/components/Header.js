...
const Header = () => {
  ...
  useEffect(() => {
    ...
    myHeaders.append("apikey", "UWzjwfPSh7nO4Qayk12t5R5bE5jES3nO");
        ...
        <div className="header-con">
          <div className="logo">
            <Link to="/">
              <Button>
                <img
                  src="https://images.unidays.world/i/customers/mobile/active/145a87b6-c372-49e7-a403-bf357eb75708"
                  alt=""
                />
              </Button>
            </Link>
            <Link className="nav-item" to="/">
              <Button color="">Главная</Button>
            </Link>
            <a className="nav-item" href="#">
              <Button color="">О нас</Button>
            </a>
            <Link className="nav-item" to="/rated">
              <Button color="">Избранное</Button>
            </Link>
            <Link to="/basket" className="nav-item">
              <Button color="">Корзина</Button>
            </Link>
            <div>
              <select
                onChange={(e) =>
                  dispatch({ type: PUSH_RESET, payload: e.target.value })
                }
              >
          ...
          <div className="">
            ...
            <Link to="/basket">
              <IconButton aria-label="cart">
                <StyledBadge
                  badgeContent={card.length > 0 ? card.length : 0}
                  color="secondary"
                >
